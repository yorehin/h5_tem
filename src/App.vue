      ...
      <swiper-slide>
        <section  class="MySlider2">
          <div class="bounce" style="height:100vh; display: flex;flex-direction: column;">
            ...
            <img src="./assets/TaxBureau/cutChart/b/icon2.png" width="4%" style="margin-left: 33%; margin-top: 13%"/>
      ...
      <swiper-slide>
        <section  class="MySlider3">
          <div style="display: flex;flex-direction: column;">
            ...
            <img src="./assets/TaxBureau/cutChart/c/arrow.png" width="14.8%" style="margin-top: 32%; margin-left: 53%;"/>
            <img src="./assets/TaxBureau/cutChart/c/arrow.png" width="14.8%" style="margin-top: 8%; margin-left: 53%;"/>
      ...
      <swiper-slide>
        <section  class="MySlider4">
          <div style="display: flex;flex-direction: column;">
            ...
            <img src="./assets/TaxBureau/cutChart/d/arrow.png" width="14.8%" style="margin-left: 53%; margin-top: 40%"/>
            <img src="./assets/TaxBureau/cutChart/d/car.png" width="40.4%" style="margin-left: 33%; margin-top: 39%"/>
          </div>
        </section>
      </swiper-slide>
      <swiper-slide>
        <section  class="MySlider5">
          <div style="display: flex;flex-direction: column;">
            ...
            <img src="./assets/TaxBureau/cutChart/e/arrow.png"  width="14.8%" style="margin-left: 53%; margin-top: 45%"/>
            <img src="./assets/TaxBureau/cutChart/e/arrow.png"  width="14.8%" style="margin-left: 53%; margin-top: 8%"/>
          </div>
        </section>
      </swiper-slide>
      <swiper-slide>
        <section  class="MySlider6">
          <div style="display: flex;flex-direction: column; height: 100vh">
            ...
            <img src="./assets/TaxBureau/cutChart/e/arrow.png"  width="14.8%" style="margin-left: 52%; margin-top: -83%"/>
            <img src="./assets/TaxBureau/cutChart/e/arrow.png"  width="14.8%" style="margin-left: 52%; margin-top: 21%"/>
            <div style="flex: 1;">&nbsp;</div>
      ...
      <swiper-slide>
        <section  class="MySlider7">
          <div style="display: flex;flex-direction: column;">
            ...
            <img src="./assets/TaxBureau/cutChart/e/arrow.png" width="14.8%" style="margin-left: 53%; margin-top: 31%"/>
            <img src="./assets/TaxBureau/cutChart/e/arrow.png" width="14.8%" style="margin-left: 53%; margin-top: 8%"/>
          </div>
        </section>
      </swiper-slide>
      <swiper-slide>
        <section  class="MySlider8">
          <div style="display: flex;flex-direction: column;">
            ...
            <img src="./assets/TaxBureau/cutChart/h/backBlue.png" width="50%" style="margin-left: 47px; margin-top: 74px"/>
            <div style="margin-top: -27px; margin-left: 75px; font-weight: bold; font-size: 15px; color: #2d69ba">扩大进项税抵扣范围</div>
            <img src="./assets/TaxBureau/cutChart/h/car.png" width="46.4%" style="margin: 76% auto 0"/>
          </div>
        </section>
      </swiper-slide>
      <swiper-slide>
        <section  class="MySlider9">
          <div style="display: flex;flex-direction: column;">
            ...
            <img src="./assets/TaxBureau/cutChart/i/backBlue.png" width="56.4%" style="margin-left: 8%; margin-top: 20%"/>
            <div style="margin-top: -7%; margin-left: 14%; font-weight: bold; font-size: 15px; color: #2d69ba">允许不动产进项一次抵扣</div>
            <img src="./assets/TaxBureau/cutChart/i/change.png"  width="14.8%" style="margin-left: 45%; margin-top: 43%"/>
            <img src="./assets/TaxBureau/cutChart/i/one.png" width="29.73%" style="margin-left: 63%; margin-top: -17%"/>
            <div style="flex:1;" >&nbsp;</div>
            <img src="./assets/TaxBureau/cutChart/i/backDown.png" width="100%" style="margin-bottom: 0px"/>
          </div>
        </section>
      </swiper-slide>
      <swiper-slide>
        <section  class="MySlider10">
          <div style="display: flex;flex-direction: column;">
            ...
            <img src="./assets/TaxBureau/cutChart/j/ride.png" width="8.13%" style="margin-left: 16%; margin-top: 50%"/>
            <img src="./assets/TaxBureau/cutChart/j/provision.png" width="16.13%" style="margin-left: 35%; margin-top: -15%"/>
      ...
      <swiper-slide>
        <section  class="MySlider11">
          <div style="display: flex;flex-direction: column;">
            ...
            <img src="./assets/TaxBureau/cutChart/k/backDown.png" width="100%" style="margin-top: -8%"/>
          </div>
        </section>
      </swiper-slide>
...
import sup from './assets/TaxBureau/cutChart/a/bulb.png'
...
export default {
  ...
  mounted () {
    ...
    wx.config({
      ...
      appId: 'wx7e14b4c8e816eeaa', // 必填，公众号的唯一标识
      timestamp: Date.now(), // 必填，生成签名的时间戳
      nonceStr: 'lli', // 必填，生成签名的随机串
      signature: 'yangg', // 必填，签名
      jsApiList: ['onMenuShareTimeline',
        'onMenuShareAppMessage', 'updateTimelineShareData'] // 必填，需要使用的JS接口列表
    })
